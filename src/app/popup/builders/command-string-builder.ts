export class CommandStringBuilder {
  ...
  constructor(clipName: string, videoId: string, startTimeSeconds: number, endTimeSeconds: number, botName: string, clipTags: string) {
    ...
    this.ClipTags = clipTags.trim().toLowerCase();
  ...
  build(): string {
    ...
    return "@" + this.BotName + " add-clip " + this.ClipName + " " + this.VideoId + " " + startTimeString + " " + endTimeString + " " + this.ClipTags;
  }
